...
.sectionbar .sbsp{
  ...
  background:var(--surface-3); border:1px solid var(--brass-line); border-radius:5px;
}
.sectionbar .sbsp img{max-width:22px; max-height:22px; width:auto; height:auto}
.sectionbar h2{margin:0; font-family:"Pixelify Sans",sans-serif; font-weight:600; font-size:17px; line-height:1.1}
.sectionbar .sbnote{
...
table.crafts th.c-res{width:33%}
tr.modrow th{
...
td.res{border-right:1px solid var(--line)}
...
.it .sp{
  ...
  background:var(--slot-bg); border:1px solid var(--slot-line); border-radius:3px;
  box-shadow:inset 0 1px 0 var(--slot-in);
}
.it .sp img{max-width:24px; max-height:24px; width:auto; height:auto}
...
ul.ing{list-style:none; margin:0; padding:0; display:flex; flex-direction:column; gap:2px}
ul.ing li{display:flex; align-items:center; gap:4px; flex-wrap:wrap}
ul.ing li::before{
  content:""; width:4px; height:4px; border-radius:50%; background:var(--line-strong);
