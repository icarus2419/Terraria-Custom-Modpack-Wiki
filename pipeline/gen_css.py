...
:root{
  ...
  --rar-blend:#0a070c; --rar-amt:48%;
  --ui-shadow:none; --wordshadow:rgba(28,22,32,.15); --grid:rgba(28,22,32,.06);
  color-scheme:light;
}
@media (prefers-color-scheme:dark){
  :root:not([data-theme="light"]){
    ...
    --rar-blend:#0a070c; --rar-amt:22%;
    --ui-shadow:0 1px 0 rgba(0,0,0,.6); --wordshadow:rgba(0,0,0,.75); --grid:rgba(255,225,240,.035);
    color-scheme:dark;
  }
}
...
:root{--stars:radial-gradient(1px 1px at 32.38% 15.08%,rgba(255,238,245,0.329) 50%,transparent 51%),radial-gradient(1px 1px at 7.24% 53.59%,rgba(255,238,245,0.255) 50%,transparent 51%),radial-gradient(1px 1px at 5.8% 50.74%,rgba(255,238,245,0.17) 50%,transparent 51%),radial-gradient(1px 1px at 43.36% 6.99%,rgba(255,238,245,0.184) 50%,transparent 51%),radial-gradient(1px 1px at 42.45% 82.69%,rgba(255,238,245,0.192) 50%,transparent 51%),radial-gradient(1px 1px at 22.32% 62.74%,rgba(255,238,245,0.406) 50%,transparent 51%),radial-gradient(1px 1px at 57.71% 39.67%,rgba(255,238,245,0.414) 50%,transparent 51%),radial-gradient(1px 1px at 4.66% 85.85%,rgba(255,238,245,0.235) 50%,transparent 51%),radial-gradient(1px 1px at 14.43% 11.78%,rgba(255,238,245,0.24) 50%,transparent 51%),radial-gradient(1px 1px at 81.61% 18.07%,rgba(255,238,245,0.311) 50%,transparent 51%),radial-gradient(1px 1px at 63.89% 37.24%,rgba(255,238,245,0.302) 50%,transparent 51%),radial-gradient(1px 1px at 6.28% 5.96%,rgba(255,238,245,0.214) 50%,transparent 51%),radial-gradient(1px 1px at 68.04% 42.76%,rgba(255,238,245,0.242) 50%,transparent 51%),radial-gradient(1px 1px at 58.56% 45.32%,rgba(255,238,245,0.238) 50%,transparent 51%),radial-gradient(1px 1px at 79.44% 69.9%,rgba(255,238,245,0.223) 50%,transparent 51%),radial-gradient(1px 1px at 57.44% 52.52%,rgba(255,238,245,0.388) 50%,transparent 51%),radial-gradient(1px 1px at 72.94% 28.79%,rgba(255,238,245,0.415) 50%,transparent 51%),radial-gradient(1px 1px at 11.81% 41.81%,rgba(255,238,245,0.357) 50%,transparent 51%),radial-gradient(1px 1px at 15.2% 48.9%,rgba(255,238,245,0.17) 50%,transparent 51%),radial-gradient(1px 1px at 66.82% 76.46%,rgba(255,238,245,0.309) 50%,transparent 51%),radial-gradient(1px 1px at 87.55% 31.37%,rgba(255,238,245,0.341) 50%,transparent 51%),radial-gradient(1px 1px at 59.44% 57.99%,rgba(255,238,245,0.279) 50%,transparent 51%),radial-gradient(1px 1px at 84.0% 94.47%,rgba(255,238,245,0.283) 50%,transparent 51%),radial-gradient(1px 1px at 66.42% 6.07%,rgba(255,238,245,0.342) 50%,transparent 51%),radial-gradient(1px 1px at 64.71% 99.31%,rgba(255,238,245,0.374) 50%,transparent 51%),radial-gradient(1px 1px at 28.46% 38.58%,rgba(255,238,245,0.334) 50%,transparent 51%),radial-gradient(1px 1px at 2.26% 46.17%,rgba(255,238,245,0.204) 50%,transparent 51%),radial-gradient(1px 1px at 11.71% 5.9%,rgba(255,238,245,0.36) 50%,transparent 51%),radial-gradient(1px 1px at 12.93% 24.76%,rgba(255,238,245,0.262) 50%,transparent 51%),radial-gradient(1px 1px at 87.14% 8.06%,rgba(255,238,245,0.277) 50%,transparent 51%),radial-gradient(1px 1px at 54.94% 88.34%,rgba(255,238,245,0.373) 50%,transparent 51%),radial-gradient(1px 1px at 86.4% 27.84%,rgba(255,238,245,0.268) 50%,transparent 51%),radial-gradient(1px 1px at 35.88% 88.42%,rgba(255,238,245,0.409) 50%,transparent 51%),radial-gradient(1px 1px at 15.09% 17.62%,rgba(255,238,245,0.22) 50%,transparent 51%),radial-gradient(1px 1px at 23.33% 48.5%,rgba(255,238,245,0.313) 50%,transparent 51%),radial-gradient(1px 1px at 26.27% 0.41%,rgba(255,238,245,0.269) 50%,transparent 51%),radial-gradient(1px 1px at 36.93% 56.63%,rgba(255,238,245,0.408) 50%,transparent 51%),radial-gradient(1px 1px at 69.05% 51.55%,rgba(255,238,245,0.321) 50%,transparent 51%),radial-gradient(1px 1px at 67.62% 5.4%,rgba(255,238,245,0.394) 50%,transparent 51%),radial-gradient(1px 1px at 78.0% 87.45%,rgba(255,238,245,0.367) 50%,transparent 51%),radial-gradient(1px 1px at 39.24% 39.9%,rgba(255,238,245,0.187) 50%,transparent 51%),radial-gradient(1px 1px at 63.43% 6.22%,rgba(255,238,245,0.178) 50%,transparent 51%),radial-gradient(1px 1px at 20.88% 16.23%,rgba(255,238,245,0.248) 50%,transparent 51%),radial-gradient(1px 1px at 5.26% 0.02%,rgba(255,238,245,0.199) 50%,transparent 51%),radial-gradient(1px 1px at 10.15% 36.36%,rgba(255,238,245,0.167) 50%,transparent 51%),radial-gradient(1px 1px at 87.43% 61.41%,rgba(255,238,245,0.199) 50%,transparent 51%),radial-gradient(2px 2px at 25.23% 34.74%,rgba(255,238,245,0.431) 50%,transparent 51%),radial-gradient(2px 2px at 12.28% 84.89%,rgba(255,238,245,0.658) 50%,transparent 51%),radial-gradient(2px 2px at 46.6% 48.38%,rgba(255,238,245,0.331) 50%,transparent 51%),radial-gradient(2px 2px at 10.22% 34.26%,rgba(255,238,245,0.395) 50%,transparent 51%),radial-gradient(2px 2px at 82.89% 16.14%,rgba(255,238,245,0.308) 50%,transparent 51%),radial-gradient(2px 2px at 95.1% 52.83%,rgba(255,238,245,0.353) 50%,transparent 51%),radial-gradient(2px 2px at 54.32% 2.7%,rgba(255,238,245,0.49) 50%,transparent 51%),radial-gradient(2px 2px at 97.85% 86.33%,rgba(255,238,245,0.551) 50%,transparent 51%),radial-gradient(2px 2px at 26.11% 36.67%,rgba(255,238,245,0.36) 50%,transparent 51%),radial-gradient(2px 2px at 77.19% 53.26%,rgba(255,238,245,0.58) 50%,transparent 51%),radial-gradient(2px 2px at 32.97% 22.3%,rgba(255,238,245,0.592) 50%,transparent 51%),radial-gradient(2px 2px at 98.49% 85.26%,rgba(255,238,245,0.59) 50%,transparent 51%),radial-gradient(2px 2px at 81.83% 73.99%,rgba(255,238,245,0.382) 50%,transparent 51%),radial-gradient(2px 2px at 51.76% 35.56%,rgba(255,238,245,0.31) 50%,transparent 51%)}
